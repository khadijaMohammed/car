    ...
    <div class="be-wrapper be-fixed-sidebar">
      <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
          <div class="navbar-header"><a href="index.html" class="navbar-brand">Car Showroom</a></div>
      ...
      <div class="be-left-sidebar col-lg-4">
            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="active"><a href="{{route('admin.cars.index')}}"><i class="icon mdi mdi-home"></i><span>Dashboard</span></a>
                  </li>


                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Brands</span></a>
                  <ul class="sub-menu">
                      <li><a href="{{route('admin.brands.index')}}">Brands List</a>
                      </li>
                      <li><a href="{{route('admin.brands.create')}}">Add Brand</a>
                      </li>
                
                    </ul>
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-chart-donut"></i><span>Cars</span></a>
                    <ul class="sub-menu">
                      <li><a href="{{route('admin.cars.index')}}">Cars List</a>
                      </li>
                      <li><a href="{{route('admin.cars.create')}}">Add Car</a>
                      </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Models</span></a>
                  <ul class="sub-menu">
                      <li><a href="{{route('admin.models.index')}}">Models List</a>
                      </li>
                      <li><a href="{{route('admin.models.create')}}">Add Model</a>
                      </li>
